...
=======
    ...
    self.senderId = AvatarId;
    self.senderDisplayName = AvatarDisplayName;
    
    self.inputToolbar.contentView.textView.pasteDelegate=self;
    
    self.ChatData = [[ChatViewData alloc]init];

    [JSQMessagesCollectionViewCell registerMenuAction:@selector(customAction:)];
    [UIMenuController sharedMenuController].menuItems = @[[[UIMenuItem alloc]initWithTitle:@"CustomAction action" action:@selector(customAction:)]];
    
    [JSQMessagesCollectionViewCell resolveClassMethod:@selector(delegate)];
